...
public abstract class CertificateAuthorityActivationCommand extends CertificateAuthorityCommand {
    ...
    protected final IpResourceSet resources;
    protected final long parentId;

    public CertificateAuthorityActivationCommand(VersionedId certificateAuthorityId, CertificateAuthorityCommandGroup commandGroup, X500Principal name, IpResourceSet resources, long parentId) {
