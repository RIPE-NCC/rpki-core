...
public class HostedCertificateAuthorityData extends ManagedCertificateAuthorityData {
    public HostedCertificateAuthorityData(VersionedId versionedId, X500Principal name, UUID uuid, Long parentId, IpResourceSet resources, List<KeyPairData> keys) {
