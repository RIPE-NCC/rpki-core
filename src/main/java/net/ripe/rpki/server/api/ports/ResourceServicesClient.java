...
public interface ResourceServicesClient {
    ...
    class MemberResources {
        ...
        public Map<String, Integer> getMemberResourcesCounts() {
            return Map.of(
                "Asn", asns.size(),
                "Ipv4Allocations", ipv4Allocations.size(),
                "Ipv4Assignments", ipv4Assignments.size(),
                "Ipv6Allocations", ipv6Allocations.size(),
                "Ipv6Assignments", ipv6Assignments.size(),
                "Ipv4ErxResources", ipv4ErxResources.size()
            );
        }
    }
